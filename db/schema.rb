...
ActiveRecord::Schema.define(version: 20130110095412) do
  ...
  add_index "archived_exam_scores", ["student_id", "exam_id"], name: "index_archived_exam_scores_on_student_id_and_exam_id", using: :btree
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], name: "score_index", using: :btree
  ...
  add_index "attendances", ["month_date", "batch_id"], name: "index_attendances_on_month_date_and_batch_id", using: :btree
  add_index "attendances", ["student_id", "batch_id"], name: "index_attendances_on_student_id_and_batch_id", using: :btree
  ...
  add_index "batch_students", ["batch_id", "student_id"], name: "index_batch_students_on_batch_id_and_student_id", using: :btree
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], name: "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", using: :btree
  ...
  add_index "cce_grades", ["cce_grade_set_id"], name: "index_cce_grades_on_cce_grade_set_id", using: :btree
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], name: "cce_report_join_index", using: :btree
  ...
  add_index "cce_weightages_courses", ["cce_weightage_id"], name: "index_cce_weightages_courses_on_cce_weightage_id", using: :btree
  add_index "cce_weightages_courses", ["course_id", "cce_weightage_id"], name: "index_for_join_table_cce_weightage_courses", using: :btree
  add_index "cce_weightages_courses", ["course_id"], name: "index_cce_weightages_courses_on_course_id", using: :btree
  ...
  add_index "class_timings", ["batch_id", "start_time", "end_time"], name: "index_class_timings_on_batch_id_and_start_time_and_end_time", using: :btree
  ...
  add_index "configurations", ["config_key"], name: "index_configurations_on_config_key", length: {"config_key"=>10}, using: :btree
  add_index "configurations", ["config_value"], name: "index_configurations_on_config_value", length: {"config_value"=>10}, using: :btree
  ...
  add_index "courses", ["grading_type"], name: "index_courses_on_grading_type", using: :btree
  ...
  add_index "courses_observation_groups", ["course_id"], name: "index_courses_observation_groups_on_course_id", using: :btree
  add_index "courses_observation_groups", ["observation_group_id"], name: "index_courses_observation_groups_on_observation_group_id", using: :btree
  ...
  add_index "descriptive_indicators", ["describable_id", "describable_type", "sort_order"], name: "describable_index", using: :btree
  ...
  add_index "employees", ["employee_number"], name: "index_employees_on_employee_number", length: {"employee_number"=>10}, using: :btree
  ...
  add_index "employees_subjects", ["subject_id"], name: "index_employees_subjects_on_subject_id", using: :btree
  ...
  add_index "events", ["is_common", "is_holiday", "is_exam"], name: "index_events_on_is_common_and_is_holiday_and_is_exam", using: :btree
  ...
  add_index "exam_scores", ["student_id", "exam_id"], name: "index_exam_scores_on_student_id_and_exam_id", using: :btree
  ...
  add_index "exams", ["exam_group_id", "subject_id"], name: "index_exams_on_exam_group_id_and_subject_id", using: :btree
  ...
  add_index "fa_criterias", ["fa_group_id"], name: "index_fa_criterias_on_fa_group_id", using: :btree
  ...
  add_index "fa_groups_subjects", ["fa_group_id", "subject_id"], name: "score_index", using: :btree
  add_index "fa_groups_subjects", ["fa_group_id"], name: "index_fa_groups_subjects_on_fa_group_id", using: :btree
  add_index "fa_groups_subjects", ["subject_id"], name: "index_fa_groups_subjects_on_subject_id", using: :btree
  ...
  add_index "finance_fees", ["fee_collection_id", "student_id"], name: "index_finance_fees_on_fee_collection_id_and_student_id", using: :btree
  ...
  add_index "grading_levels", ["batch_id", "is_deleted"], name: "index_grading_levels_on_batch_id_and_is_deleted", using: :btree
  ...
  add_index "grouped_batches", ["batch_group_id"], name: "index_grouped_batches_on_batch_group_id", using: :btree
  ...
  add_index "grouped_exam_reports", ["batch_id", "student_id", "score_type"], name: "by_batch_student_and_score_type", using: :btree
  ...
  add_index "grouped_exams", ["batch_id", "exam_group_id"], name: "index_grouped_exams_on_batch_id_and_exam_group_id", using: :btree
  add_index "grouped_exams", ["batch_id"], name: "index_grouped_exams_on_batch_id", using: :btree
  ...
  add_index "observations", ["observation_group_id"], name: "index_observations_on_observation_group_id", using: :btree
  ...
  add_index "period_entries", ["month_date", "batch_id"], name: "index_period_entries_on_month_date_and_batch_id", using: :btree
  ...
  add_index "previous_exam_scores", ["student_id", "exam_id"], name: "index_previous_exam_scores_on_student_id_and_exam_id", using: :btree
  ...
  add_index "reminders", ["recipient"], name: "index_reminders_on_recipient", using: :btree
  ...
  add_index "student_additional_details", ["student_id", "additional_field_id"], name: "student_data_index", using: :btree
  ...
  add_index "students", ["admission_no"], name: "index_students_on_admission_no", length: {"admission_no"=>10}, using: :btree
  add_index "students", ["batch_id"], name: "index_students_on_batch_id", using: :btree
  add_index "students", ["first_name", "middle_name", "last_name"], name: "index_students_on_first_name_and_middle_name_and_last_name", length: {"first_name"=>10, "middle_name"=>10, "last_name"=>10}, using: :btree
  add_index "students", ["nationality_id", "immediate_contact_id", "student_category_id"], name: "student_data_index", using: :btree
  ...
  add_index "students_subjects", ["student_id", "subject_id"], name: "index_students_subjects_on_student_id_and_subject_id", using: :btree
  ...
  add_index "subject_leaves", ["month_date", "subject_id", "batch_id"], name: "index_subject_leaves_on_month_date_and_subject_id_and_batch_id", using: :btree
  add_index "subject_leaves", ["student_id", "batch_id"], name: "index_subject_leaves_on_student_id_and_batch_id", using: :btree
  ...
  add_index "subjects", ["batch_id", "elective_group_id", "is_deleted"], name: "index_subjects_on_batch_id_and_elective_group_id_and_is_deleted", using: :btree
  ...
  add_index "timetables", ["start_date", "end_date"], name: "by_start_and_end", using: :btree
  ...
  add_index "users", ["username"], name: "index_users_on_username", length: {"username"=>10}, using: :btree
