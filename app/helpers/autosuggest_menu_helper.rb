  ...
  def autosuggest_menuitems
    Rails.cache.fetch("user_autocomplete_menu#{session[:user_id]}"){
      ...
      default = [
        ...
        {:menu_type => 'link' ,:label => 'autosuggest_menu.settings',:value =>{:controller => :FedenaConfiguration,:action => :index}},
        ...
        {:menu_type => 'link' ,:label => 'autosuggest_menu.general_settings',:value =>{:controller => :FedenaConfiguration,:action => :settings}},
