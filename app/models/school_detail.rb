...
class SchoolDetail < ActiveRecord::Base
  ...
  :path => ":Rails.root/public/system/:class/:attachment/:id_partition/:style/:basename.:extension",
  :default_url  => 'application/app_fedena_logo.png',
  :default_path  => ':Rails.root/public/images/application/app_fedena_logo.png'
